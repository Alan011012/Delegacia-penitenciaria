    ...
    <div class="flex">
        <div class="w-64 h-screen bg-black text-white fixed top-0 left-0 pt-16 border-r border-gray-800">
            ...
            <div class="space-y-4 mt-6 px-4">
                <a href="{{ route('dashboard') }}" class="block py-2 px-4 rounded-md text-gray-300  hover:bg-yellow-600 hover:text-black rounded-md transition duration-200 ease-in-out">
                    Início
                </a>
                <a href="{{ route('presos.index') }}" class="block py-2 px-4 rounded-md  hover:bg-yellow-600 hover:text-black rounded-md transition duration-200 ease-in-out">
                    Presos
                </a>
                <a href="{{ route('celas.index') }}" class="block py-2 px-4 rounded-md  hover:bg-yellow-600 hover:text-black rounded-md transition duration-200 ease-in-out">
                    Celas
                </a>
                <a href="{{ route('visitas.index') }}" class="block py-2 px-4 rounded-md  hover:bg-yellow-600 hover:text-black rounded-md transition duration-200 ease-in-out">
                    Visitas
                </a>
                <a href="{{ route('visitantes.index') }}" class="block py-2 px-4 rounded-md  hover:bg-yellow-600 hover:text-black rounded-md transition duration-200 ease-in-out">
                    Visitantes
                </a>
            </div>
        </div>
