...
@section('content')
    ...
    @if (session('success'))
    <div id="successModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-gray-900 p-6 rounded-lg shadow-lg w-96 opacity-100">
    ...
    <div id="errorModal" class="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-gray-900 p-6 rounded-lg shadow-lg w-96 opacity-100">
            <h3 class="text-lg font-semibold text-white">{{ session('error') }}</h3>
            <div class="mt-4 text-center">
                <button onclick="closeErrorModal()" class="px-6 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700">
                    Fechar
                </button>
            </div>
        </div>
