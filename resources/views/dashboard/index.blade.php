    ...
    <div class="bg-black text-white p-4 fixed w-full top-0 left-0 z-10">
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-6">
                <span class="text-lg font-semibold bg-yellow-500 text-black px-4 py-2 rounded-full shadow-lg hover:bg-yellow-600 transition duration-300 ease-in-out">
                    Bem-vindo
                    {{ auth()->user()->name }}
                </span>
                <div class="relative">
    ...
    <div class="flex mt-16">
        <div class="w-64 h-screen bg-black text-white fixed top-0 left-0 shadow-xl transition-transform ease-in-out">
            ...
            <div class="space-y-6 mt-8">
                <a href="{{ route('dashboard') }}" class="flex items-center py-3 px-4 text-sm text-gray-200 hover:bg-yellow-600 hover:text-black rounded-md transition duration-200 ease-in-out">
                    Inicio
                </a>
                <a href="{{ route('presos.index') }}" class="flex items-center py-3 px-4 text-sm text-gray-200 hover:bg-yellow-600 hover:text-black rounded-md transition duration-200 ease-in-out">
                    Presos
                </a>
                <a href="{{ route('celas.index') }}" class="flex items-center py-3 px-4 text-sm text-gray-200 hover:bg-yellow-600 hover:text-black rounded-md transition duration-200 ease-in-out">
                    Celas
                </a>
                <a href="{{ route('visitas.index') }}" class="flex items-center py-3 px-4 text-sm text-gray-200 hover:bg-yellow-600 hover:text-black rounded-md transition duration-200 ease-in-out">
                    Visitas
                </a>
                <a href="{{ route('visitantes.index') }}" class="flex items-center py-3 px-4 text-sm text-gray-200 hover:bg-yellow-600 hover:text-black rounded-md transition duration-200 ease-in-out">
                    Visitantes
                </a>
            </div>
        </div>
            ...
            <div class="bg-gray-700 overflow-hidden shadow-xl sm:rounded-lg transition-shadow duration-300">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                        ...
                        <a href="{{ route('presos.index') }}" class="bg-yellow-400 text-black p-8 rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 hover:translate-y-2">
                        ...
                        <a href="{{ route('celas.index') }}" class="bg-gray-800 text-white p-8 rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 hover:translate-y-2">
                        ...
                        <a href="{{ route('visitas.index') }}" class="bg-yellow-400 text-black p-8 rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 hover:translate-y-2">
                        ...
                        <a href="{{ route('visitantes.index') }}" class="bg-gray-800 text-white p-8 rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 hover:translate-y-2">
